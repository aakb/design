...
<nav class="submenu">
  <div class="submenu--inner">
    ...
    <div class="submenu--links is-right">
      <a href="<?php echo $path_to_site; ?>/screen/" class="submenu--icon-link is-active"><i class="material-icons">apps</i></a>
      <a href="<?php echo $path_to_site; ?>/screen/planning/" class="submenu--icon-link"><i class="material-icons">event_note</i></a>
    </div>
  </div>
</nav>
